...
public class Example_CollectorToCounting {
	...
	public static void main(String[] args) {
       ...
       //using lambda
       long total= studlist.stream().filter(x->x.getAge()>22).collect(Collectors.counting());
       System.out.println("Total students age >22 is :"+total);
	}
