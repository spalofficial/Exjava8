...
public class Example_CollectorToPartionBy {
	...
	public static void main(String[] args) {
       ...
       //partition based on age . if age > 25 then in one partition else other partition

       //using lambda
       Map<Boolean,List<Student>> agewisepartition	 =  studlist.stream().
    		   collect(Collectors.partitioningBy(x->x.getAge()<=25, Collectors.toList()));
       
       //using method referencing
       System.out.println(agewisepartition);
